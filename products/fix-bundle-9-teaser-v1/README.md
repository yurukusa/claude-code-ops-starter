...
These 2 hooks cover Self-Check items #2 and #4. The remaining items (#7 outbound gate, #8 error RCA, #9 activity logging, and more) are available in the [CC-Codex Ops Kit ($9.99)](https://yurukusa.github.io/cc-ops-kit-landing/) — 22 files, 15-minute setup.
